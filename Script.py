...
Myself <a href=https://t.me/{}>{}</a>,\n\nTrust me ! I can't even imagine how super-fast i can drive your Database channel \n\nAre you ready for Long Drive Baby...🤪"""
    LZTHMB_TEXT = """Hello {},
Glad to see you here. It seems that you really love <a href=https://t.me/NGROCKEr >NGROCKER's</a> work.\n\n<b>Thumbnail extracting</b> feature will be available soon, please join <a href=https://t.me/LazyDeveloper>Dev Channel</a> and stay tuned for next <a href=https://t.me/mrcupdate>update</a>.\n\n  🐞 Report Bug here: <a href=http://t.me/NGROCKER>ADMIN</a>
    """
    LZLINK_TEXT = """Hey {},
Glad to see you here. It seems that you really love <a href=https://t.me/LazyNGROCKEr >NGROCKER's</a> work.\n\n<b>File to LiNK converting</b> feature will be available soon, please join <a href=https://t.me/MRCUPDATE>Dev Channel</a> and stay tuned for next <a href=https://t.me/mrcupdate>update</a>.\n\n  🐞 Report Bug here: <a href=http://t.me/NGROCKERt>ADMIN</a>
    """
    DNT_TEXT = """Hey sweetie {},
Thanks for thinking about us.\nIt seems that you really love <a href=https://t.me/NGROCKEr >NGROCKER's</a> work.\n\n<b>For your kind information, we do not ask or force anyone for any kind of payment</b>. But if you really want to donate us then you can send money to us from below links...\n\n💵 Reach Donation Page : <a href=http://t.me/NGROCKER>Click here...</a>\n\nT❤️ hank you so much..
    """
    REQ_AUTH_TEXT = """Hello {},
\nSorry sweetie.. You must have to be the Authentic User to complete this operation...\n\n👮‍♀ REPORT ISSUE HERE: <a href=https://t.me/NGROCKER>LazyDeveloper Support</a>\n\n
    """
...
"""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/Ngrocker>ADARSH</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: PAID
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v10.0.0 [ 𝙱𝙴𝚃𝙰 ]"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- MRC is an open source project. 
- DJ Rmixes - https://t.me/adarshmedias  
- Please give a star to this repo after fork. Salute to <a href=https://t.me/ngrocker>Ngrocker</a> for adding extra features in me.

<b>DEV:</b>
- 🦋 <a href=https://t.me/NGROCKER>NGROCKER</a> 🦋"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and MRC will respond whenever that keyword hits the message
...
<b>NOTE:</b>
these are the extra features of MRC
