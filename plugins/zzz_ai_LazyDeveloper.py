...
#                 footer_credit = "🦋<a href='https://telegram.me/NGROCKER'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://telegram.me/NGROCKER'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a>🦋"
...
#                 print(error)
#                 await message.reply_text(f'ERROR VANNU BRO 😀\n\n{error}')
#     else:
#         return
